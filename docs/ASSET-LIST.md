...
| `weather/heat.png` — **regenerate: see §19.4 at the end (the first plate read as yellow squiggles)** | *"A thin horizontal band of cartoon heat shimmer: wavy pale-yellow ripple lines with thin ink outlines, on a flat solid neon-green #00FF00 background. Saturday-morning comic-book illustration: bold, uniform black ink outlines; flat, saturated cel-shaded colors with simple hard-edged two-tone shadows; exaggerated cartoon proportions and big expressive faces; dynamic low or tilted camera angles; motion lines, speed lines, and dust puffs for action; a subtle halftone-dot texture in the shadows; clean bright backgrounds. Palette: ink black, interstate red #C41E2A, ocean-wave blue #1F8FD6, sunflower yellow #FFC72C, lime green #7AC143, sky blue #5BC0EB, hot orange #F58220, grape purple #6A4C93, white. Original characters and an original van. No gradients, no painterly texture, no photorealism, no speech balloons, no text unless specified. Same illustrated universe as the other 8 West Trail assets."* |
...
| `billboards/8westit-05.png` | source art retained but excluded from live rotation; white face, a cartoon padlock in sunglasses lounging on a beach chair, headline "RANSOMWARE? NOT ON OUR ROAD." and "8 WEST IT 365" |
...
| `billboards/8westit-07.png` | source art retained but excluded from live rotation; yellow face, three big green checkmarks beside "PATCHED. BACKED UP. BEACH-READY." and "8 WEST IT 365" |
...
### 19.4 · Heat shimmer plate, second try — `weather/heat.png` ★
The first attempt came back as three thin wavy yellow lines across the middle of the frame —
lines, not haze. This is a translucent *layer* the game lays over the road on scorching days,
so it needs to read as rising heat: soft, wide, and mostly empty. 8:3, min 3200×1200, CUTOUT
on neon-green #00FF00.
```
A comic-book heat-haze overlay for a hot desert road, 8:3 landscape: rising heat distortion
drawn as many loose, wobbly, VERTICAL ripple strokes in pale yellow-white and pale orange with
very thin ink outlines, densest along the bottom third and fading out toward the top, with a
few short wavy horizontal shimmer marks near the bottom edge; the strokes are scattered and
airy with lots of open space between them, like the wobble above hot asphalt; no sun, no
ground, no horizon, no objects, no solid shapes, no text; everything that is not a stroke is
flat solid neon-green #00FF00. Saturday-morning comic-book illustration: bold, uniform black
ink outlines; flat, saturated cel-shaded colors with simple hard-edged two-tone shadows; a
subtle halftone-dot texture; clean bright backgrounds. Palette: ink black, sunflower yellow
...
- **Ford badges** — a few images (the cover, the outfitter, cover No. 3, the river strips) show a
  Ford oval on the van's grille. Real trademark on our own van: paint it out in post.
