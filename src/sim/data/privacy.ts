...
export const PRIVACY_NOTE: readonly string[] = [
  ...
  'We use Google Analytics to see how many people play and how far they get. It sets cookies, and it doesn’t tell us who you are. To stop bots, the game uses Cloudflare Turnstile when you post. To stop spam, we keep a scrambled version of your internet address for 30 days and then delete it; nobody can turn it back into you.',
